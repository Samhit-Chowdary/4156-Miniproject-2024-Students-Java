...
/**
 * Represents a test suite for the Department class which will test all functionalities and will
...
public class DepartmentUnitTests {
  ...
  public static void setupCourseForTesting() {
    ...
    courses.put(
        "Software Engineering", new Course("Griffin Newbold", "417 IAB", "11:40-12:55", 250));
    courses.put(
        "Adv Software Engineering", new Course("Peter Lose", "418 IAB", "12:30-13:55", 250));
